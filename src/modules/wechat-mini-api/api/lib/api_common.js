...
class API {
  ...
  constructor(appid, appsecret, getToken, saveToken, tokenFromCustom) {
    ...
    this.mpPrefix = 'https://api.weixin.qq.com/cgi-bin/';
    this.fileServerPrefix = 'http://file.api.weixin.qq.com/sns/';
  ...
  async request(url, opts, retry) {
    ...
    var contentType = "application/json"//res.headers['content-type'] || '';
  ...
  async getAccessToken() {
    var url = this.mpPrefix + 'token?grant_type=client_credential&appid=' + this.appid + '&secret=' + this.appsecret;
